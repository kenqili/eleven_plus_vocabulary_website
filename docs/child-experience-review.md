...
- All 2,249 headwords and phrases have static British-English MP3 pronunciation. The generation voice is Azure Speech `en-GB-SoniaNeural`. Explicit IPA distinguishes adjective **deliberate** and verb **delegate**. Playback is user initiated, one recording at a time, and can be retried after failure.
...
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Child-friendly meanings, clues and British pronunciation    | 2,249 meanings, 6,530 answer-safe clues and 2,249 packaged MP3s; browser playback and failure/retry checks                                                                                                         |
...
| Engaging stories at six levels                              | 120 local text stories, 10 per level at Level 0 and 22 per level at Levels 1–5, with complete vocabulary coverage, 15–30 marked targets. The required count is derived from each level's word count, so a larger bank simply needs more stories; independent simulated editorial reviews in `data/stories/review-*.md`                               |
| Read-along audio for every story                            | 120 packaged narrations from `audio:stories:generate`; text-drift validation, browser playback, pause/rewind, missing and failed recording notices, single-clip playback and phone/tablet/desktop layout checks |
