...
| Engaging stories at six levels                              | Local text stories with complete vocabulary coverage, 15–30 marked targets and at least 10 per level including Level 0. The required count is derived from each level's word count, so a larger bank simply needs more stories; independent simulated editorial reviews in `data/stories/review-*.md`                               |
